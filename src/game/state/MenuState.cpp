...
namespace game {
    ...
    void MenuState::enter(Game &game) {
        ...
        std::shared_ptr<engine::ITextBoxComponent> play_button_text =
                game.getViewComponentCreator()->createTextBox(button_size, 1, true, "PTSans-bold");
        ...
        _play_button = std::make_shared<UIButton>(UIButton(
                ...
                game.getViewComponentCreator()->createAnimatedSprite(button_size, 0, true, "button_anim"),
                {play_button_text}
        ));
