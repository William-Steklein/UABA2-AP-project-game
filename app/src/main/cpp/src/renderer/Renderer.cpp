...
//                                                     constants::window_title);
    ...
    Renderer::Renderer() : _running(true) {
        _window = std::make_shared<sf::RenderWindow>(sf::VideoMode::getDesktopMode(),
                                                     constants::window_title, sf::Style::Fullscreen);
        ...
        _game = std::make_unique<game::Game>(0, _screen_width, _screen_height, 0,
                                             ...
                                             std::make_shared<FileReader>(FileReader()));
