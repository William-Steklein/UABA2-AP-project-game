...
namespace game {
    ...
    protected:
        ...
        std::shared_ptr<Button> _left_touch_button;
        std::shared_ptr<Button> _right_touch_button;
        std::shared_ptr<Button> _crouch_touch_button;
        std::shared_ptr<Button> _jump_touch_button;
        std::map<game::InputEvent::Type, bool> _is_touching;

        std::shared_ptr<Button> _menu_button;
        ...
        virtual void createTouchControls();

        virtual void handleTouchControlsInput();
    };
